 ...
 * as incomming data, and notifies when a distributed
 * transation becomes STABLE (client side). Everything else is hidden
 * from the user.
 *
 * Concurrency
 * -----------
 ...
 *  user operation. dtx cannot be destoried until it reached STABLE state.
 *
 * States
 * ------
